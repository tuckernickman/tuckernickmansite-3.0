                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <a href="2020.html" class="field-group-link project-link d-block p-visible">
                                                            <div class="project-img bg">
                                                                <img class="img-fluid" src="assets/img/2020/vogelkorper.jpg" alt="bird carcass">
                                                            </div>
                                                            <div class="project-year">
                                                                <small>
                                                                    Carcass
                                                    ...
                                                    <div class="col-sm-4">
                                                        <a href="2019.html" class="field-group-link project-link d-block p-visible">
                                                            <div class="project-img bg">
                                                                <img class="img-fluid" src="assets/img/2019/Wuste.jpg" alt="desert image 2019">
                                                            </div>
                                                            <div class="project-year">
                                                                <small>
                                                                    Desert Image
                                        ...
                                        <section>
                                            ...
                                            <div class="field field-name-field-paragraph">
                                                <div class="setion-content">
                                                    <div class="text-max-width mx-auto onecol">

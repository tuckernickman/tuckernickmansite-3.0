<div class="col">
            <?php if (isset($contactFormStatus) && is_array($contactFormStatus) && $contactFormStatus['message'] !== ''): ?>
                <div class="alert <?php echo $contactFormStatus['type'] === 'success' ? 'alert-success' : 'alert-danger'; ?> fade show">
                    <?php echo esc_html((string)$contactFormStatus['message']); ?>
                </div>
            <?php endif; ?>
            ...
            <form name="contactForm" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" onsubmit="event.preventDefault(); validateForm();">
                ...
                <div class="form-group">
                    ...
                    placeholder="First name" aria-describedby="First Name" required>
                </div>
                <div class="form-group">
                    <label for="lname" class="txt-color">Last Name</label>
                    <input id="lname" type="text" name="lname" class="form-control txt-color"
                    placeholder="Last name" aria-describedby="Last Name" required>
                </div>
                <div class="form-group">
                    ...
                    placeholder="Your Email" aria-describedby="Your Email" required>
               </div>
               <div class="form-group">
                    <label for="phone" class="txt-color">Phone Number</label>
                    <input id="phone" type="text" name="phone" class="form-control txt-color"
                    placeholder="Phone Number" aria-describedby="Phone Number" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    placeholder="Enter Your Message Here" aria-describedby="Enter Your Message Here" required></textarea>
                </div>
               <div class="col-12">
